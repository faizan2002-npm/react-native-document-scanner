...
// Generated spec for new architecture
import com.documentscanner.NativeRNPdfScannerManagerSpec;

/**
 * Created by andre on 28/11/2017.
 * Migrated to TurboModule for new architecture support.
 * 
 * For new architecture: extends NativeRNPdfScannerManagerSpec (generated by codegen)
 * For old architecture: extends ReactContextBaseJavaModule implements TurboModule
 */

public class DocumentScannerModule extends NativeRNPdfScannerManagerSpec {

    public static final String NAME = "RNPdfScannerManager";
